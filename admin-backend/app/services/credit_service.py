...
def grant_credits(db: Session, user: User, amount: int, admin_id: int, note: str | None = None) -> CreditLedger:
...
def adjust_credits(db: Session, user: User, amount: int, admin_id: int, note: str | None = None) -> CreditLedger:
...
def reset_credits(db: Session, user: User, new_balance: int, admin_id: int, note: str | None = None) -> CreditLedger:
