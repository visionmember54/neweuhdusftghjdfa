...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    icon: 'chart',
    items: [
      { label: 'Simulation Statistics', href: '/dashboard/reports/simulation-statistics' },
      { label: 'Game Statistics', href: '/dashboard/reports/game-statistics' },
      { label: 'Number Frequency', href: '/dashboard/reports/number-frequency' },
      { label: 'Historical Charts', href: '/dashboard/reports/historical-charts' },
    ],
  },
  {
    title: 'System',
    ...
    items: [
      ...
      { label: 'Admin Users', href: '/dashboard/system/admin-users' },
